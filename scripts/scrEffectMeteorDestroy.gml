...
part_type_size(particle1,0.10,0.17,0,0);
part_type_scale(particle1,3.22,1.33);
part_type_color3(particle1,4776643,9866649,3551537);
part_type_alpha3(particle1,0.97,0.43,0.05);
part_type_speed(particle1,2.51,5.41,0,0);
